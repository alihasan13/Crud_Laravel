...
<script src="<?php echo e(asset('public/js/dataTable.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/js/customDatatable.js')); ?>" type="text/javascript"></script>
<!--Wave Effects -->
...
<script src="<?php echo e(asset('public/assets/plugins/bootstrap/js/select2.js')); ?>"></script>
<!-- Chart JS -->

<!--script for swl-->

<!-- Optional: include a polyfill for ES6 Promises for IE11 --><?php /**PATH K:\server\htdocs\laravelProject\resources\views/defaults/footerScript.blade.php ENDPATH**/ ?>